    ...
    <div className="container mx-auto py-12 md:py-24 px-4 md:px-6">
      ...
      <div className="mt-20 max-w-3xl mx-auto bg-gray-50 p-6 rounded-lg border border-gray-200">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h3 className="font-medium">Can I try the paid features before subscribing?</h3>
            <p className="text-gray-600">Yes, we offer a 14-day trial of any paid plan. No credit card required.</p>
          </div>
        </div>
      </div>
    </div>
