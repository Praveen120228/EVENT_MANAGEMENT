...
// Email content component that uses the searchParams hook
    ...
    <div className="w-full max-w-md space-y-8 px-4">
      ...
      <Card className="animate-pulse">
        <CardHeader>
          ...
          <CardTitle className="text-center">Loading verification details</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-md bg-gray-50 p-4 h-16"></div>
        </CardContent>
        <CardFooter className="flex justify-center p-4">
          <div className="w-32 h-10 bg-emerald-100 rounded-md"></div>
        </CardFooter>
      </Card>
    </div>
  )
