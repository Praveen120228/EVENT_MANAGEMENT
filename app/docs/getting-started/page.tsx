                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mb-8">
                    <Link href="/docs/events">
                      <div className="border rounded-lg p-4 hover:border-emerald-500 hover:shadow-sm transition-all">
                        ...
                        <p className="text-sm text-gray-500">Learn about event types and advanced settings</p>
                      </div>
                    </Link>
                    ...
                    <Link href="/docs/guests">
                      <div className="border rounded-lg p-4 hover:border-emerald-500 hover:shadow-sm transition-all">
                        ...
                        <p className="text-sm text-gray-500">Advanced guest list management techniques</p>
                      </div>
                    </Link>
